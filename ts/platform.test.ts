...
describe('Platform', () => {
	...
	describe('#getPlatformInfo()', () => {
		...
		it('throws cl.INVALID_VALUE with name=cl.DEVICE_TYPE_CPU', () => {
			assert.throws(() => cl.getPlatformInfo(platform, cl.DEVICE_TYPE_CPU), cl.INVALID_VALUE);
		});

		it('throws cl.INVALID_VALUE with name=0x2000', () => {
			assert.throws(() => cl.getPlatformInfo(platform, 0x2000), cl.INVALID_VALUE);
		});
		...
		it('throws cl.INVALID_VALUE with name=-123.56', () => {
			assert.throws(() => cl.getPlatformInfo(platform, -123.56), cl.INVALID_VALUE);
		});
