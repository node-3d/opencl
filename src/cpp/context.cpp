...
JS_METHOD(getContextInfo) {
	...
	switch (param_name) {
		...
		case CL_CONTEXT_NUM_DEVICES: {
			...
			CHECK_ERR(clGetContextInfo(context, param_name, sizeof(cl_uint), &param_value, nullptr));
			RET_NUM(param_value);
		}
		case CL_CONTEXT_DEVICES: {
			...
			CHECK_ERR(
			    clGetContextInfo(context, param_name, sizeof(cl_device_id) * n, devices.get(), nullptr)
			);
		...
		case CL_CONTEXT_PROPERTIES: {
			...
			CHECK_ERR(
			    clGetContextInfo(context, param_name, sizeof(cl_context_properties) * n, ctx.get(), nullptr)
			);
